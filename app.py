...
# --- CONFIGURATION ---
BOSS_NAME = "Xu Zhi Jun"  # Personalized for your boss
# Column Names (Matches the database CSV)
DB_ID_COL = 'DB Number'
...
st.write("Upload your **Excel sheet** and the **CSV database** below to sync your files.")
        ...
        try:
            ...
            for i in range(len(sheet_df)):
                ...
                if match:
                    ...
                    sheet_df.iat[i, 7] = clean_val(row.get(DB_SHOPTEST_COL)) # Col H
